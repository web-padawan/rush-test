...
describe('DirMixin', () => {
  ...
  it('should propagate direction as dir attribute to the element from the documentElement', async () => {
    expect(
      await elementDirectionsAreCorrect(['rtl', 'ltr', '', 'rtl', null], ['rtl', 'ltr', null, 'rtl', null], element)
    ).to.be.true;
  });
  ...
  it('should preserve direction if was set by the user', async () => {
    ...
    expect(
      await elementDirectionsAreCorrect(['rtl', 'ltr', '', 'rtl', null], ['ltr', 'ltr', 'ltr', 'ltr', 'ltr'], element)
    ).to.be.true;
  });
  ...
  it('should subscribe to the changes if set to equal the document direction', async () => {
    ...
    expect(await elementDirectionsAreCorrect(['rtl', 'ltr', 'rtl'], ['ltr', 'ltr', 'ltr'], element)).to.be.true;

    element.setAttribute('dir', 'rtl');

    expect(await elementDirectionsAreCorrect(['ltr', 'rtl', ''], ['ltr', 'rtl', null], element)).to.be.true;
  });
  ...
  it('should unsubscribe if attribute set by the user', async () => {
    expect(await elementDirectionsAreCorrect(['rtl', 'ltr', 'rtl'], ['rtl', 'ltr', 'rtl'], element)).to.be.true;

    element.setAttribute('dir', 'ltr');

    expect(await elementDirectionsAreCorrect(['ltr', 'rtl', ''], ['ltr', 'ltr', 'ltr'], element)).to.be.true;
  });
});
