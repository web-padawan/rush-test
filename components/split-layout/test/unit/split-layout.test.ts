...
describe('split-layout', () => {
  ...
  describe('styles', () => {
    ...
    it('should reset flex on first element when removed', async () => {
      track(splitter, 10, 0);
    ...
    it('should reset flex on second element when removed', async () => {
      track(splitter, 10, 0);
  ...
  describe('content elements', () => {
    ...
    it('should reset slot attribute on first element when removed', async () => {
      layout.removeChild(first);
      await nextFrame();
      expect(first.hasAttribute('slot')).to.be.false;
    });

    it('should reset slot attribute on second element when removed', async () => {
      layout.removeChild(second);
      await nextFrame();
